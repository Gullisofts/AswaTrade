...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="reset_done_msg">
            <div class="reset_msg img-thumbnail">
                <i class="fas fa-exclamation-circle reset_correct_ico" data-aos="flip-left" data-aos-delay="500"></i>
                <h4 class="mt-3 first_reset_heading" data-aos="fade-left" data-aos-delay="1000"> أتبعت رابط غير صحيح</h5>
                <a href="/" type="button" class="btn btn-primary mt-3 reset_done_btn" data-aos="fade-up" data-aos-delay="2000">الذهاب للرئيسية</a>
            </div>
        </div>
        @else
        <div class="reset_done_msg">
            <div class="reset_msg img-thumbnail">
                ...
                <h4 class="mt-3 first_reset_heading" data-aos="fade-left" data-aos-delay="1000">تم تفعيل حسابك بنجاح</h5>
                <p class="mt-3 second_reset_heading" data-aos="fade-left" data-aos-delay="1000">سيتم تحويلك تقائيا بعد 5 ثواني.....</p>
                <a href="/" type="button" class="btn btn-primary mt-3 reset_done_btn" data-aos="fade-up" data-aos-delay="2000">الذهاب للرئيسية</a>
            </div>
        </div>
